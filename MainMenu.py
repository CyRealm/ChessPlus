...
def main_menu(screen):
    ...
    menu_text = font.render("CHESS+", False, (0, 0, 0))
    screen.blit(menu_text, (0,0))

    play_button = Button(image = pygame.image.load("assets/Play.png"), pos = (0, 0),text_input = "PLAY",
                         font = pygame.font.SysFont('Calibri', 35), base_colour = "#d7fcd4", hovering_colour = "White")
    options_button = Button(image = pygame.image.load("assets/Options.png"), pos = (0, 0),text_input="OPTIONS",
                         font = pygame.font.SysFont('Calibri', 35), base_colour = "#d7fcd4", hovering_colour = "White")
    quit_button = Button(image = pygame.image.load("assets/Quit.png"), pos = (0, 0), text_input="QUIT",
                         font = pygame.font.SysFont('Calibri', 35), base_colour = "#d7fcd4", hovering_colour = "White")
